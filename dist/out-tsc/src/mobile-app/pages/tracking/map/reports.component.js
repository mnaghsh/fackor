...
var ReportsComponent = /** @class */ (function () {
    function ReportsComponent(route, myRoute, reportsService, commonService, userService, localStorageService, dialog) {
        this.route = route;
        ...
        this.dialog = dialog;
        this.displayedColumns = ['select', 'id', 'name', 'details'];
    ...
    ReportsComponent.prototype.findNameOfReport = function () {
        ...
        //   this.nameOfReport=element.name;
        // });
    };
